...
<div class="page privacy-page">
  ...
  <section class="section">
    <div class="container privacy-content">
      ...
      <p>This is the personal site of Carlo Caprini, based in Italy. Questions about this notice or the data described here can be sent through the <a href="{{ site.data.person.linkedin }}" target="_blank" rel="noopener noreferrer" data-analytics-event="contact_open" data-analytics-contact-method="linkedin" data-analytics-link-context="privacy">LinkedIn contact shown on the site</a>.</p>

      <h2>Optional analytics</h2>
      <p>Google Analytics 4 is used to understand which pages, notes and editorial paths are useful. It may receive the page visited, interactions with the site, device and browser information, and an approximate location derived from network information.</p>
      <p>Analytics is disabled by default. The Google Analytics script is not loaded and Analytics cookies are not created unless you select “Accept analytics”. The legal basis for this optional processing is your consent, which you can withdraw at any time through “Cookie settings” in the footer.</p>
